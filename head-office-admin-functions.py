...
def approve_reorders():
    try:
        with open("reorder_requests.txt", "r") as file:
        ...
        with open("approved_orders.txt", "w") as file:
        ...
        print("reorder_requests.txt not found.")
...
def generate_reports():
    try:
        ...
        with open("store_history.txt", "r") as f:
            for line in f:
                outlet_id, pid, action, qty, timestamp = line.strip().split(",")
                qty = int(qty)
        ...
        with open("inventory.txt", "r") as f:
            for line in f:
                pid, name, cat, outlet_id, qty, threshold = line.strip().split(",")
